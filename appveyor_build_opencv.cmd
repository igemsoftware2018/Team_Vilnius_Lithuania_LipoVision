...
appveyor DownloadFile https://github.com/opencv/opencv/archive/3.4.2.zip -FileName c:\opencv\opencv-3.4.2.zip
7z x c:\opencv\opencv-3.4.2.zip -oc:\opencv -y
del c:\opencv\opencv-3.4.2.zip /q
appveyor DownloadFile https://github.com/opencv/opencv_contrib/archive/3.4.2.zip -FileName c:\opencv\opencv_contrib-3.4.2.zip
